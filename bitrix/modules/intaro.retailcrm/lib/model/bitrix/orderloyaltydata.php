...
class OrderLoyaltyData
{
    ...
    /**
     * –азмер обычной скидки на единицу товара в позиции
     *
     * Ёта скидка определ€етс€ в правилах работы с корзиной
     *
    ...
    /**
     *  оличество списываемых бонусов по позиции
     *
     * @var float
     *
     * @Mapping\Type("float")
    ...
    /**
     *  оличество списываемых бонусов по всему заказу
     *
     * @var float
     *
     * @Mapping\Type("float")
