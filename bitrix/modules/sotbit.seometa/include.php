...
class CCSeoMeta
{
    ...
    public static function PropMenu(
        ...
        if (Loader::includeModule('sotbit.regions') && !\SotbitRegions::isDemoEnd()) {
            ...
            foreach ($tags as $tag) {
                ...
                $str .= "<div class='with-prop' data-prop='" . SotbitRegions::genCodeVariable($tag['CODE']) . "'>" . $name . "</div>";
            }
    ...
    public static function checkDemo()
    {
        ...
        if (CCSeoMeta::ReturnDemo() == 2) {
            echo '<div class="adm-info-message-wrap adm-info-message-red">
                    <div class="adm-info-message">
                        <div class="adm-info-message-title">' . Loc::getMessage("SEO_META_CT_LIST_DEMO") . '</div>
        ...
        if (CCSeoMeta::ReturnDemo() == 3 || CCSeoMeta::ReturnDemo() == 0) {
            echo '<div class="adm-info-message-wrap adm-info-message-red">
                <div class="adm-info-message">
                    <div class="adm-info-message-title">' . Loc::getMessage("SEO_META_CT_LIST_DEMO_END") . '</div>
                    <div class="adm-info-message-icon"></div>
                </div>
            </div>';
    ...
    DataManager
{
    ...
    public static function saveFile(array $arFile, $del = false)
    {
        $arFile[key($arFile)] = \CIBlock::makeFileArray($arFile[key($arFile)],
            $del,
            $_REQUEST[key($arFile)] ? '' : $_REQUEST[key($arFile)]['name']
        );
