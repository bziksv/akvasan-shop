...
class CSeoMetaSitemapLight
{
    ...
    function generateSitemapFinish($ID, $index)
    {
        ...
        if (Loader::includeModule('sotbit.regions') && method_exists(\Sotbit\Regions\Seo\File::class, 'generateRegionsSitemap')) {
            \Sotbit\Regions\Seo\File::generateRegionsSitemap($sitePaths['site_id']);
        }
