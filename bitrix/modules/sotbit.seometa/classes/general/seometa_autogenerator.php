...
class CSeoMetaAutogenerator
{
        ...
        if(Loader::includeModule('iblock')) {
            ...
            if (!empty($arIBlockList)) {
                ...
                foreach ($arIBlockList as $intIBlockID) {
                    ...
                    $groups[$iblockName . " [" . $intIBlockID . "]"] = $arrProps;
                }
    ...
    public function startGeneration($condition) {
        ...
        if ($condition['NAME_TEMPLATE']) {
            ...
            $arrSect = \Sotbit\Seometa\Helper\AdminSection\Tools::getIblockSectionListName($sections);
        ...
        foreach ($allCombs as $id => $combination) {
            ...
            $data['TAG'] = $meta['TAGS'];
            $data['ELEMENT_TAG'] = $meta['ELEMENT_TAG'];
            $data['CATEGORY_TAGS_SECTION_ID'] = $meta['CATEGORY_TAGS_SECTION'];
            $data['CATEGORY_TAGS_DETAIL_ID'] = $meta['CATEGORY_TAGS_DETAIL_SECTION'];
            unset($meta['ELEMENT_TAG'], $meta['TAGS'], $meta['CATEGORY_TAGS_SECTION'], $meta['CATEGORY_TAGS_DETAIL_SECTION']);
