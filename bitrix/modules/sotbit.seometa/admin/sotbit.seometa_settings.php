...
$site_id = EscapePHPString($request->get('site'));
...
$arOptions = [
    ...
    'TAGS_FILTER' => [
        'GROUP' => 'GROUP_SETTINGS',
        'TITLE' => GetMessage( $moduleId.'_TAGS_FILTER' ),
        'TYPE' => 'CHECKBOX',
        'REFRESH' => 'N',
        'SORT' => '23',
        'DEFAULT' => 'N',
        'NOTES' => GetMessage( $moduleId.'_TAGS_FILTER_NOTE' )
    ],
...
if($RIGHT != "D")
{
    ...
    if($_POST){
        ...
        $agentExec = $_POST['AGENT_EXEC'] ?: Option::get($moduleId,'AGENT_EXEC','', $site_id);
        if(!$agentExec){
        ...
        $agentInterval = $_POST['AGENT_INTERVAL'] ?: Option::get($moduleId,'AGENT_INTERVAL','86400', $site_id);
        if(!$agentInterval){
