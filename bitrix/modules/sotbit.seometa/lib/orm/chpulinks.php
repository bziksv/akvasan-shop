...
class ChpuLinksTable extends \DataManagerEx_SeoMeta
{
    ...
    public static function getMap(
        ...
        return [
            ...
            'MAIN_REAL_URL' => [
                'data_type' => 'string',
                'title' => Loc::getMessage('SEOMETA_LINKS_MAIN_REAL_URL'),
            ],
            'LINK_REAL_URL' => [
                'data_type' => 'string',
                'title' => Loc::getMessage('SEOMETA_LINKS_LINK_REAL_URL'),
            ],
            'SITE_ID' => [
                'data_type' => 'string',
                'title' => Loc::getMessage('SEOMETA_LINKS_SITE_ID')
            ],
    ...
    public static function getByLinkChpuId(
        $linkChpuId
    ) {
        $res = self::getList([
            'select' => ['*'],
