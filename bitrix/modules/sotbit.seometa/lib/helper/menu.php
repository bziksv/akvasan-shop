        ...
        if ($APPLICATION->GetGroupRight($iModuleID) != "D") {
            ...
            $aMenu = [
                ...
                'items' => [
                    ...
                    [
                        "text" => Loc::getMessage("MENU_SEOMETA_CATEGORY_TAGS_LIST_TEXT"),
                        "url" => "sotbit.seometa_category_tags_list.php?lang=" . LANGUAGE_ID,
                        "more_url" => [
                            "sotbit.seometa_category_tags_list.php",
                            "sotbit.seometa_category_tags_edit.php",
                        ],
                        "title" => Loc::getMessage("MENU_SEOMETA_CATEGORY_TAGS_LIST_TITLE")
                    ],
                    [
                    ...
                    [
                        "text" => Loc::getMessage("MENU_SEOMETA_AI_TEXT"),
                        "title" => Loc::getMessage("MENU_SEOMETA_AI_TITLE"),
                        "items_id" => "menu_sotbit.seometa.ai",
                        "dynamic" => true,
                        "items" => [
                            [
                                "text" => Loc::getMessage("MENU_SEOMETA_AI_SETTINGS_TEXT"),
                                "url" => "sotbit.seometa_ai_settings.php?lang=" . LANGUAGE_ID,
                                "title" => Loc::getMessage("MENU_SEOMETA_AI_SETTINGS_TITLE")
                            ],
                            [
                                "text" => Loc::getMessage("MENU_SEOMETA_AI_LIST_TEXT"),
                                "url" => "sotbit.seometa_ai_request_list.php?lang=" . LANGUAGE_ID,
                                "title" => Loc::getMessage("MENU_SEOMETA_AI_LIST_TITLE"),
                            ],
                        ],
                    ],
                    [
