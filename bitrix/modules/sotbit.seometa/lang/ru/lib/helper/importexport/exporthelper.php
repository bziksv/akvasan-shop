...
*3 - id свойства инфоблока (можно использовать символьный код свойства),
...
Так же могут использоваться те же шаблоны, что и при создании условия через административную часть.
...
Так же могут использоваться те же шаблоны, что и при создании условия через административную часть.
К примеру - {=this.Name}{=concat {=ProductProperty \"BRAND_REF\" } \", \"}";
$MESS['SEOMETA_EXPORTHELPER_COND_DESCRIPTION_ELEMENT_TAG'] = "Поле отвечает за вывод тегов на детальной странице элемента.";
$MESS['SEOMETA_EXPORTHELPER_COND_EXAMPLE_ELEMENT_TAG'] = "Возможные значения: любое сочетание букв и символов.
Так же могут использоваться те же шаблоны, что и при создании условия через административную часть.
К примеру - {=this.Name}{=concat {=ProductProperty \"BRAND_REF\" } \", \"}";
...
$MESS['SEOMETA_EXPORTHELPER_CHPU_EXAMPLE_ELEMENT_ADD_DESC'] = "Возможные значения: любое сочетание букв и символов.";
