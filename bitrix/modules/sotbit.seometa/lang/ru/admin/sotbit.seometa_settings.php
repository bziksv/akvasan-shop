...
$MESS[$moduleId.'_SITEMAP_FILE_SIZE_NOTE'] = "Указывается для ограничения максимального размера генерируемого файла карты сайта модулем Сотбит: Умный фильтр.<br>Размер требуется писать в мегабайтах, только число. (пример: 30 -- что равно 30Mb)<br> Для правильной работы максимальный размер равен 50 Mb. (по умолчанию установлено значение равное 50 Mb)";

$MESS[$moduleId.'_SITEMAP_COUNT_LINKS'] = "Максимальное количество ссылок в одном файле (seometa_sitemap)";
$MESS[$moduleId.'_SITEMAP_COUNT_LINKS_NOTE'] = "Указывается для ограничения максимального количества ссылок записываемых в файл карты сайта модулем Сотбит: Умный фильтр.<br>Для правильной работы максимальный размер равен 50000. (по умолчанию установлено значение равное 50000)";
...
$MESS[$moduleId . "_TAGS_FILTER"] = 'Формирование тегов строго по условию фильтра';
$MESS[$moduleId . "_TAGS_FILTER_NOTE"] = 'Параметр активирует альтернативный вывод тегов.<br> Будут выводиться только те теги, которые совпадают и не противоречат значениям выбранными пользователем в фильтре.<br>
<b>Пример</b>: Значение фильтра - обувь 42 размера.<br>
Параметры условия - nike 42 размера, adidas 42 размера, nike 43 размера, adidas 43 размера.<br>
Выводимые теги: nike 42 размера, adidas 42 размера';
?>
