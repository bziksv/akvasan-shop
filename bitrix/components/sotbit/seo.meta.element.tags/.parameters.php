    ...
    "PARAMETERS" => [
        ...
        "INCLUDE_SUBSECTIONS" => [
            ...
            "VALUES" => [
                ...
                "A" => Loc::getMessage('SM_INCLUDE_SUBSECTIONS_ACTIVE'),
                "N" => Loc::getMessage('SM_INCLUDE_SUBSECTIONS_NO'),
            ],
            "DEFAULT" => "Y",
        ],
        "INCLUDE_PARENTSECTIONS" => [
            "PARENT" => "BASE",
            'NAME' => Loc::getMessage('SM_INCLUDE_PARENTSECTIONS'),
            "TYPE" => "LIST",
            "VALUES" => [
                "Y" => Loc::getMessage('SM_INCLUDE_PARENTSECTIONS_ALL'),
                "N" => Loc::getMessage('SM_INCLUDE_PARENTSECTIONS_NO'),
            ],
            "DEFAULT" => "Y",
        ],
        'SORT' => [
