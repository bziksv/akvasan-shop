...
$arParams['SECTION_ID'] = $arParams['SECTION_ID'] ?? 0;
...
SeoMetaMorphy::init($arParams['SECTION_ID'], \CSeoMetaTagsProperty::$params);
...
if(empty($arResult) && !empty($metaData)){
    ...
    if (!empty($result['TITLE'])) {
        ...
        $sotbitSeoMetaTitle = SeoMetaMorphy::processMorphy($result['TITLE']);
        $sotbitSeoMetaTitle = SeoMetaMorphy::convertMorphy($sotbitSeoMetaTitle);
    ...
    if (!empty($result['KEYWORDS'])) {
        ...
        $sotbitSeoMetaKeywords = SeoMetaMorphy::processMorphy($result['KEYWORDS']);
        $sotbitSeoMetaKeywords = SeoMetaMorphy::convertMorphy($sotbitSeoMetaKeywords);
    ...
    if (!empty($result['DESCRIPTION'])) {
        ...
        $sotbitSeoMetaDescription = SeoMetaMorphy::processMorphy($result['DESCRIPTION']);
        $sotbitSeoMetaDescription = SeoMetaMorphy::convertMorphy($sotbitSeoMetaDescription);
    ...
    if (!empty($result['PAGE_TITLE'])) {
        ...
        $sotbitSeoMetaH1 = SeoMetaMorphy::processMorphy($result['PAGE_TITLE']);
        $arResult['ELEMENT_H1'] = $sotbitSeoMetaH1 .= $paginationText ?: '';
        $sotbitSeoMetaH1 = SeoMetaMorphy::convertMorphy($sotbitSeoMetaH1);
    ...
    if (!empty($result['BREADCRUMB_TITLE'])) {
        ...
        $sotbitSeoMetaBreadcrumbTitle = SeoMetaMorphy::processMorphy($result['BREADCRUMB_TITLE']);
        $sotbitSeoMetaBreadcrumbTitle = SeoMetaMorphy::convertMorphy($sotbitSeoMetaBreadcrumbTitle);
    ...
    if (!empty($result['ELEMENT_TOP_DESC'])) {
        ...
        $sotbitSeoMetaTopDesc = SeoMetaMorphy::processMorphy(html_entity_decode($result['ELEMENT_TOP_DESC']));
        $sotbitSeoMetaTopDesc = SeoMetaMorphy::convertMorphy($sotbitSeoMetaTopDesc);
    ...
    if (!empty($result['ELEMENT_BOTTOM_DESC'])) {
        ...
        $sotbitSeoMetaBottomDesc = SeoMetaMorphy::processMorphy(html_entity_decode($result['ELEMENT_BOTTOM_DESC']));
        $sotbitSeoMetaBottomDesc = SeoMetaMorphy::convertMorphy($sotbitSeoMetaBottomDesc);
    ...
    if (!empty($result['ELEMENT_ADD_DESC'])) {
        ...
        $sotbitSeoMetaAddDesc = SeoMetaMorphy::processMorphy(html_entity_decode($result['ELEMENT_ADD_DESC']));
        $sotbitSeoMetaAddDesc = SeoMetaMorphy::convertMorphy($sotbitSeoMetaAddDesc);
    ...
    if ($results && is_array($results)) {
        foreach ($results as $result) //set metatags
        {
            ...
            if (!empty($result['KEYWORDS'])) {
                ...
                $sotbitSeoMetaKeywords = SeoMetaMorphy::processMorphy($result['KEYWORDS']);
                $sotbitSeoMetaKeywords = html_entity_decode(SeoMetaMorphy::convertMorphy($sotbitSeoMetaKeywords));
                $APPLICATION->SetPageProperty("keywords", $sotbitSeoMetaKeywords);
                $issetCondition = true;
            }
            ...
            if (!empty($result['DESCRIPTION'])) {
                ...
                $sotbitSeoMetaDescription = SeoMetaMorphy::processMorphy(html_entity_decode($result['DESCRIPTION']));
                $sotbitSeoMetaDescription = html_entity_decode(SeoMetaMorphy::convertMorphy($sotbitSeoMetaDescription));
                $sotbitSeoMetaDescription .= $paginationText ?: '';
                $APPLICATION->SetPageProperty("description", $sotbitSeoMetaDescription);
                $issetCondition = true;
            }
            ...
            if(is_array($arOGParams) && $arOGParams['OG_FIELD_ACTIVE'] == 'Y') {
                ...
                foreach ($arOGParams as $name => $value) {
                    if($name == 'OG_FIELD_TITLE' || $name == 'OG_FIELD_DESCRIPTION') {
                        $afterProcess = SeoMetaMorphy::processMorphy($value);
        ...
        if($notConfiguredSeoData['ACTIVE'] == 'Y' && CSeoMeta::isFilterChecked()) {
            ...
            if ($notConfiguredSeoData['META_ELEMENT_TITLE']) {
                ...
                $sotbitSeoMetaTitle = SeoMetaMorphy::processMorphy($notConfiguredSeoData['META_ELEMENT_TITLE']);
                $sotbitSeoMetaTitle = SeoMetaMorphy::convertMorphy($sotbitSeoMetaTitle);
                $sotbitSeoMetaTitle .= $paginationText ?: '';
            ...
            if ($notConfiguredSeoData['META_ELEMENT_KEYWORDS']) {
                ...
                $sotbitSeoMetaKeywords = SeoMetaMorphy::processMorphy($notConfiguredSeoData['META_ELEMENT_KEYWORDS']);
                $sotbitSeoMetaKeywords = SeoMetaMorphy::convertMorphy($sotbitSeoMetaKeywords);
            ...
            if ($notConfiguredSeoData['META_ELEMENT_DESCRIPTION']) {
                ...
                $sotbitSeoMetaDescription = SeoMetaMorphy::processMorphy($notConfiguredSeoData['META_ELEMENT_DESCRIPTION']);
                $sotbitSeoMetaDescription = SeoMetaMorphy::convertMorphy($sotbitSeoMetaDescription);
                $sotbitSeoMetaDescription .= $paginationText ?: '';
            ...
            if ($notConfiguredSeoData['META_ELEMENT_PAGE_TITLE']) {
                ...
                $sotbitSeoMetaH1 =  SeoMetaMorphy::processMorphy($notConfiguredSeoData['META_ELEMENT_PAGE_TITLE']);
            ...
            if ($notConfiguredSeoData['META_ELEMENT_BREADCRUMB_TITLE']) {
                ...
                $url = $protocol . $curReq->getServer()->getServerName() . $port . $curReq->getRequestUri();
                $sotbitSeoMetaBreadcrumbLink = $url;
                $sotbitSeoMetaBreadcrumbTitle = SeoMetaMorphy::processMorphy(html_entity_decode($notConfiguredSeoData['META_ELEMENT_BREADCRUMB_TITLE']));
                $sotbitSeoMetaBreadcrumbTitle = SeoMetaMorphy::convertMorphy($sotbitSeoMetaBreadcrumbTitle);
            ...
            if ($notConfiguredSeoData['META_ELEMENT_TOP_DESC']) {
                ...
                $sotbitSeoMetaTopDesc = SeoMetaMorphy::processMorphy(html_entity_decode($notConfiguredSeoData['META_ELEMENT_TOP_DESC']));
                $sotbitSeoMetaTopDesc = SeoMetaMorphy::convertMorphy($sotbitSeoMetaTopDesc);
            ...
            if ($notConfiguredSeoData['META_ELEMENT_BOTTOM_DESC']) {
                ...
                $sotbitSeoMetaBottomDesc = SeoMetaMorphy::processMorphy(html_entity_decode($notConfiguredSeoData['META_ELEMENT_BOTTOM_DESC']));
                $sotbitSeoMetaBottomDesc = SeoMetaMorphy::convertMorphy($sotbitSeoMetaBottomDesc);
            ...
            if ($notConfiguredSeoData['META_ELEMENT_ADD_DESC']) {
                ...
                $sotbitSeoMetaAddDesc = SeoMetaMorphy::processMorphy(html_entity_decode($notConfiguredSeoData['META_ELEMENT_ADD_DESC']));
                $sotbitSeoMetaAddDesc = SeoMetaMorphy::convertMorphy($sotbitSeoMetaAddDesc);
...
if(Option::get("sotbit.seometa",'INC_STATISTIC','N',SITE_ID) == 'Y') {
    ...
    echo '<script> new Stat('.CUtil::PhpToJSObject(${$arParams['FILTER_NAME']}).','.$arParams['SECTION_ID'].',"'.$arParams['KOMBOX_FILTER'].'","'.SITE_ID.'","'.LANG_CHARSET.'",'.CUtil::PhpToJSObject($prop).') </script>';
}
