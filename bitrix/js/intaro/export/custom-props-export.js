...
function transliterate(titleToTransliterate)
{
    ...
    for (var i = 0; i < titleToTransliterate.length; i++) {
        switch (titleToTransliterate[i]) {
            case 'à': case 'À': translitedText += 'a'; break;
            case 'á': case 'Á': translitedText += 'b'; break;
            case 'â': case 'Â': translitedText += 'v'; break;
            case 'ã': case 'Ã': translitedText += 'g'; break;
            case 'ä': case 'Ä': translitedText += 'd'; break;
            case 'å': case 'Å': translitedText += 'e'; break;
            case '¸': case '¨': translitedText += 'yo'; break;
            case 'æ': case 'Æ': translitedText += 'zh'; break;
            case 'ç': case 'Ç': translitedText += 'z'; break;
            case 'è': case 'È': translitedText += 'i'; break;
            case 'é': case 'É': translitedText += 'y'; break;
            case 'ê': case 'Ê': translitedText += 'k'; break;
            case 'ë': case 'Ë': translitedText += 'l'; break;
            case 'ì': case 'Ì': translitedText += 'm'; break;
            case 'í': case 'Í': translitedText += 'n'; break;
            case 'î': case 'Î': translitedText += 'o'; break;
            case 'ï': case 'Ï': translitedText += 'p'; break;
            case 'ð': case 'Ð': translitedText += 'r'; break;
            case 'ñ': case 'Ñ': translitedText += 's'; break;
            case 'ò': case 'Ò': translitedText += 't'; break;
            case 'ó': case 'Ó': translitedText += 'u'; break;
            case 'ô': case 'Ô': translitedText += 'f'; break;
            case 'õ': case 'Õ': translitedText += 'h'; break;
            case 'ö': case 'Ö': translitedText += 'c'; break;
            case '÷': case '×': translitedText += 'ch'; break;
            case 'ø': case 'Ø': translitedText += 'sh'; break;
            case 'ù': case 'Ù': translitedText += 'sch'; break;
            case 'ú': case 'Ú': translitedText += ''; break;
            case 'û': case 'Û': translitedText += 'y'; break;
            case 'ü': case 'Ü': translitedText += ''; break;
            case 'ý': case 'Ý': translitedText += 'e'; break;
            case 'þ': case 'Þ': translitedText += 'yu'; break;
            case 'ÿ': case 'ß': translitedText += 'ya'; break;
