...
$APPLICATION->SetPageProperty("title", "Оплата | Способы оплаты в интернет-магазине сантехники «Аквасан»");
$APPLICATION->SetPageProperty("description", "Узнайте о доступных способах оплаты в нашем интернет-магазине. Безопасные платежи, удобные варианты расчета и прозрачные условия.");
