...
$strReturn .= '<div class="container-breadcrumb">';
...
for ($index = 0; $index < $itemSize; $index++) {
    ...
    $child = ($index > 0 ? ' itemprop="child"' : '');
        ...
        <div class="breadcrumb-item" id="bx_breadcrumb_' . $index . '" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"' . $child . $nextRef . '>
            <a href="' . $arResult[$index]["LINK"] . '" title="' . $title . '" itemprop="url"> <span>'. $title .'</span> </a>
        </div>';
}
$strReturn .= '<div class="brand-breadcrumb"></div></div>
