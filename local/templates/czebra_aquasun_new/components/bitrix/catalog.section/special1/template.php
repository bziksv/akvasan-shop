            ...
            <div class="bxslider">
                <?foreach($arResult['ITEMS'] as $arItem):?>
                    <div class="slide">
                        ...
                        <div class="name-product-slide">
                            <a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><?=TruncateText($arItem['NAME'],30)?></a>
                            <span class="size-product"><?=$arItem['DLINA_SM_1']?>х<?=$arItem['SHIRINA_SM']?>.</span>
                            <span class="manufacturer-country">
                                <img src="/upload/template_new/flag_<?=Cutil::translit($arItem["PROPERTIES"]["STRANA"]["VALUE"],"ru",array())?>.png" alt="Испания"> <span>Испания</span>
                            </span>
                        </div>
