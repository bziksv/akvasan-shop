...
<div class="container-main  login-site">
	...
	<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
		...
		<table class="bx-auth-table">
			<tr>
				<td><input class="bx-auth-input" type="text" placeholder="<?=GetMessage("AUTH_LOGIN")?>" name="USER_LOGIN" maxlength="255" value="<?=$arResult["LAST_LOGIN"]?>" /></td>
			</tr>
			<tr>
				<td><input class="bx-auth-input" type="password" name="USER_PASSWORD" maxlength="255" autocomplete="off" placeholder="<?=GetMessage("AUTH_PASSWORD")?>" />
...
<?endif?>
			<tr>
				<td class="authorize-submit-cell" style='text-align: center;'><input type="submit" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" /></td>
			</tr>
		</table>
