...
<?endif;?>
	...
	<div class="order-consent auth-form__consent">
		...
		<label for="reg_personal_consent" class="order-consent__text">Я даю <a target="_blank" href="/legal/consent/">согласие</a> на обработку персональных данных в соответствии с <a target="_blank" href="/legal/personal-data/">Политикой обработки персональных данных</a>.</label>
	</div>
