...
<table class="data-table bx-forgotpass-table bx-auth-table">
	<tbody>
		...
		<tr> 
			<td></td>
			<td>
				<input type="text" name="USER_EMAIL" maxlength="255" placeholder="<?=GetMessage("AUTH_EMAIL")?>" data-cz-validated-type="data" data-cz-validated-group="group_forgpassw" data-cz-validated-msg="* Необходимо заполнить поле" />
			</td>
		</tr>
	...
	<tfoot>
		<tr> 
			<td colspan="2" style='text-align: center;'>
				<input type="submit" id='send-passw' name="send_account_info" value="<?=GetMessage("AUTH_SEND")?>" />
			</td>
		</tr>
	</tfoot>
</table>
