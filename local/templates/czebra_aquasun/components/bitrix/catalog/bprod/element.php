...
$dopTovarID = array();
$arSelect = Array("ID", "NAME", "IBLOCK_ID","PROPERTY_PROD_BINDING");
$arFilter = Array("IBLOCK_ID" => "6", "PROPERTY_PRODUCT" => $elementId);
$res = CIBlockElement::GetList(Array(), $arFilter, false, false, $arSelect);
if ($ob = $res->GetNextElement()) {
    $arProps = $ob->GetProperties();
...
<div class="related-products col-lg-12 col-md-12 col-xs-12"><h2>похожие товары</h2><div class="workarea-related-products">
<?
$dbResult = CIBlockElement::GetList(array(), array("ID" => $elementId, "IBLOCK_ID" => $arParams['IBLOCK_ID']), false, Array("nPageSize"=>50), array("ID", "IBLOCK_ID", "IBLOCK_SECTION_ID"));
while ($arSection = $dbResult->GetNext()) {
    $idSection = $arSection["IBLOCK_SECTION_ID"];
};
GLOBAL $arrFilterRelated;
$arrFilterRelated = array("!ID" => $elementId);
?>
<?$APPLICATION->IncludeComponent(
    "bitrix:catalog.section",
    "mprod",
